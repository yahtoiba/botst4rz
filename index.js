...
//
const BotName = 'yahtoiba'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/yahtoiba'; // Nama Instagramlu cok
const whatsapplu = '0877-1474-5440'; // Nomor whatsapplu cok
